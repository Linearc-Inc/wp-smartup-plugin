              ...
              <div class="form-group-inline">
                <div class="form-group column">
                  ...
                  <div id="gender" class="form-group full-width">
                    <div class="form-group">
                      <span
                        ><input checked name="gender" value="male" type="radio"
                      /></span>
            ...
            <div class="form-group">
              ...
              <div class="form-group-inline">
                <input
                  ...
                  disabled
                  type="text"
                  placeholder="If other fill it here"
                  required
                />
              </div>
              <div class="form-group">
                <span
                  ><input type="checkbox" name="in_school" id="in_school"
                /></span>
            ...
            <div class="form-group column">
              ...
              <div class="form-group column">
                ...
                <div class="form-group full-width">
                  ...
                  /></span>
                  <label for=""
                    >I can use Internet and email, computers, word
                    processing</label
                  >
                </div>
                <div class="form-group full-width">
                  ...
                  /></span>
                  <label for=""
                    >I can use multimedia, and spreadsheets and databases</label
                  >
                </div>
                <div class="form-group full-width">
                  <span
